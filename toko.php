...
<body style="background-color: white;">
	...
	<ul style="background-color: black;">
		...
		<li class="level-0"><a href="#menu">LOKASI</a></li>
		...
		<li class="level-0" style="float:right;"><a href="#login" onclick="bukaFormulir()">MASUK</a></li>
		<li class="level-3" style="float:right;"><a href="keluar.php" onclick="">KELUAR</a></li>
		<li class="level-3" style="float:right;"><a href="#login" onclick="">MEMBER</a></li>
		<li class="level-2" style="float:right;"><a href="#login" onclick="">ADMIN</a></li>
	</ul>
	<center>
		<div class="produk">
